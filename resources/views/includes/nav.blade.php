        ...
        <ul class="nav" id="main-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{ route('user.create') }}"><i class="fa fa-user "></i>User Add</a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="{{ route('page.index') }}"><i class="fa fa-sliders"></i>Pages List</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                <a href="#"><i class="fa fa-desktop"></i>Manage Role <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{ route('role.create') }}"><i class="fa fa-sliders"></i>Add Role</a>
                    </li>
                    <li>
                        <a href="{{ route('role.index') }}"><i class="fa fa-sliders"></i>Role List</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="#"><i class="fa fa-desktop"></i>Manage Permissions <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{ route('permission.create') }}"><i class="fa fa-sliders"></i>Add Permissions</a>
                    </li>
                    <li>
                        <a href="{{ route('permission.index') }}"><i class="fa fa-sliders"></i>Permissions List</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="{{ route('enquiry') }}"><i class="fa fa-desktop"></i>Manage Enquiry</a>
            </li>
            <li>
